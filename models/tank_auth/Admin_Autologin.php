 ...
 */
class Admins_Autologin extends CI_Model {
  private $table_name = 'user_autologin';
  private $users_table_name = 'admins';
  ...
  function get($userId, $key) {
    ...
    $this->db->join($this->table_name, $this->table_name . '.userId = ' . $this->users_table_name . '.id');
    $this->db->where($this->table_name . '.userId', $userId);
